      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Contact Coach Jocelyn today to discuss elite training sessions, upcoming camps, or to create a customized performance or nutrition plan for your dedicated athlete.
          </p>
        </div>
